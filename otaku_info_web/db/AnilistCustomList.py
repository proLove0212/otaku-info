...
class AnilistCustomList(ModelMixin, db.Model):
    """
    Model that describes a custom anilist list for a user
    """
    ...
    __tablename__ = "anilist_custom_lists"
    """
    ...
    """
    The ID of the user associated with this custom list
    """

    user = db.relationship("User", backref=db.backref(
        "anilist_custom_lists", lazy=True, cascade="all,delete"
    ))
    """
    The user associated with this custom list
    """
